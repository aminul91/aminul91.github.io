...
<div id= "clothmenudetail" style="margin-top:14px;">
                             <?php foreach ($cloth as $r)
                {
                ?>
                     <div id="<?php echo $r['product_name']; ?>"> <a style="text-decoration: none;margin-bottom: 5px;" href = "<?php echo site_url('welcome/product/'.$r['product_type_id']);?>"><?php echo $r['product_name']; ?></a></div><br>
                     <?php 
                }
                ?>

                </div>
                    <div id="brandpanjabi"  style="margin-top:14px;">
    <?php 
     ...
     ?>
                        <div id ="brand">
                            <a href="<?php echo site_url('welcome/brandmenu/'.$row['shop_id'].'/1');?>" style="text-decoration: none">  <?php echo $row['brand_name'];
                                   ?>
                            </a>
                        </div>
                     <?php 
                     ...
                     <div id="brandshari" style=" margin-top:38px;">
                          <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
     ...
     ?>
                      ...
                      <div id="brandshirt" style="margin-top:62px;">
                   <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
                    ...
                    <div id="brandshari" style="margin-top:88px;">
                      <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
     ...
     ?>
                    ...
                    <div id="brandsalwar" style="margin-top:96px;">
                     <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
     ...
     ?>
                    ...
                    <div id="brandpant" style="margin-top:120px;">
                         <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
     ...
     ?>
                    ...
                    <div id="brandskirt" style="margin-top:146px;">
                            <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
     ...
     ?>
                    ...
                    <div id="brandtshirt" style="margin-top:170px;">
                         <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
 ...
 <div id="brandcother" style="margin-top:192px;">
                         <?php 
                    foreach ($result as $row)
                              {
                         if($row['category_id'] ==1)
...
<div id= "shoemenudetail" style=" margin-top:38px;">
...
<div id= "electronicmenudetail" style=" margin-top:62px;">
...
<div id= "furnituremenudetail" style=" margin-top:88px;">
...
<div id= "bagmenudetail" style=" margin-top:116px;">
...
<div id= "ornamentsmenudetail" style=" margin-top:140px;">
...
<div id= "clockmenudetail" style=" margin-top:166px;">
...
<div id= "mobilemenudetail" style=" margin-top:270px;">
...
<div id= "foodmenudetail" style=" margin-top:192px;">
...
<div id= "combindmenudetail" style=" margin-top:212px;">
...
<div id= "laptopmenudetail" style=" margin-top:298px;">
...
<div id= "othermenudetail" style=" margin-top:244px;">
