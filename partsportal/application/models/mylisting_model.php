...
class Mylisting_model extends CI_Model {
   function __construct()
   {
        parent::__construct();
   }
   
   function join_parts_equipment_parts($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function join_parts_equipment_dismantling($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function join_parts_lubes($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function join_parts_tyre($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function join_parts_workshop_parts_manuals($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function join_parts_machine_attachments($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function join_parts_workshop_tools($join_sql,$member_id)
   {
      $sql = $join_sql."
   ...
   function get_parts_information($member_id)
   {
       $result = '';
      ...
      $data['equipment_parts'] = $this->join_parts_equipment_parts($sql,$member_id);
      $data['equipment_dismantling'] = $this->join_parts_equipment_dismantling($sql,$member_id); 
      $data['parts_lubes'] = $this->join_parts_lubes($sql,$member_id);
      $data['parts_tyre'] = $this->join_parts_tyre($sql,$member_id); 
      $data['parts_manuals'] = $this->join_parts_workshop_parts_manuals($sql,$member_id);
      $data['machine_attachments'] = $this->join_parts_machine_attachments($sql,$member_id);  
      $data['workshop_tools'] = $this->join_parts_workshop_tools($sql,$member_id); 
      return $data;
   }      
}
?>